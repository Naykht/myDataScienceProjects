...
|[Телеком][21]|Яндекс.Практикум|Необходимо научиться прогнозировать отток клиентов.|pandas, sklearn, matplotlib, seaborn, numpy, catboost, кластеризация, PCA, TSNE|`Завершен`|
