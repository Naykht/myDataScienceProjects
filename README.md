...
|[Бурение скважины][3]|Яндекс.Практикум|С помощью модели машинного обучения необходимо определить регион, который принесет наибольшую прибыль.|`pandas` `numpy` `визуализация (matplotlib, seaborn)` `sklearn` `scipy` `бутстрап`|`Завершен`|
