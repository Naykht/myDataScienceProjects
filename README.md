...
|:-------|:-------:|:-------|:-------:|:-------:|
|[Предсказание цен на недвижимость][1]|ИАД|Необходимо реализовать алгоритмы kNN и линейного регрессии с нуля и добиться качества не больше 0.121 на тестовых данных по метрике *RMSE*.|`pandas` `numpy` `визуализация (matplotlib, seaborn)` `sklearn`|Завершен|
|[Предсказание стоимости автомобилей][2]|Яндекс.Практикум|Необходимо построить модель машинного обучения, которая сможет быстро и качественно подсказать клиенту рыночную стоимость автомобиля.|`pandas` `numpy` `визуализация (matplotlib, seaborn)` `sklearn` `бустинг (catboost, lightgbm)`|Завершен|
|[Бурение скважины][3]|Яндекс.Практикум|С помощью модели машинного обучения необходимо определить регион для бурения скважины, который принесет наибольшую прибыль.|`pandas` `numpy` `визуализация (matplotlib, seaborn)` `sklearn` `scipy` `бутстрап`|Завершен|
|[Коэффициент восстановления золота][4]|Яндекс.Практикум|Необходимо построить прототип модели машинного обучения для предсказания коэффициента восстановления золота из золотосодержащей руды.|`pandas` `numpy` `визуализация (matplotlib, seaborn)` `sklearn`|Завершен|
|[Шифрование данных][5]|Яндекс.Практикум|Необходимо разработать метод преобразования данных для модели линейной регрессии с целью шифрования персональной информации.|`pandas` `sklearn` `numpy`|Завершен|
- ## Нейронные сети
|Название проекта|Источник|Описание|Инструменты|Статус|
|:-------|:-------:|:-------|:-------:|:-------:|
|[Предсказание возраста покупателей по фотографии][6]|Яндекс.Практикум|Необходимо построить модель, определяющую по фотографии покупателя его возраст.|`pandas` `визуализация (matplotlib, seaborn)` `tensorflow.keras` `ResNet50`|Завершен|

## Классификация
|Название проекта|Источник|Описание|Инструменты|Статус|
|:-------|:-------:|:-------|:-------:|:-------:|
|[Предсказание наличия диабета][7]|ИАД|Необходимо предсказать наличие или отсутствие диабета у человека.|`pandas` `numpy` `визуализация (matplotlib, seaborn)` `sklearn` `бустинг` `бэггинг` `стэкинг`|Завершен|
