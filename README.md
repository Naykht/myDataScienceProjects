...
|:-------|:-------:|:-------|:-------|:-------:|
|[Предсказание цен на недвижимость][1]|ИАД|- Необходимо пеализовать алгоритмы kNN и линейного регрессии своими руками\n - Добиться того, чтобы лучший алгоритм давал качество не больше 0.121 на тестовых данных по метрике *RMSE*.|pandas, sklearn, matplotlib, seaborn, numpy|`Завершен`|
