...
**Университет (ВШЭ):**
- Ассистент по курсу:
  - [Машинное обучение (продвинутый уровень), ФЭН, 2020 (3 курс)](http://wiki.cs.hse.ru/Машинное_обучение_(ФЭН)_-_2020), 2020 (3 курс)
- Майнор, Интеллектуальный анализ данных (ИАД):
  - [Введение в анализ данных, 2020 (2 курс)](http://wiki.cs.hse.ru/Введение_в_анализ_данных_(майнор_ИАД))
  - [Современные методы машинного обучения 2020 (3 курс)](http://wiki.cs.hse.ru/Современные_методы_машинного_обучения_(майнор_ИАД))
  - [Прикладные задачи анализа данных, 2021 (3 курс)](http://wiki.cs.hse.ru/Прикладные_задачи_анализа_данных)
- Курсовая работа:
