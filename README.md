...
|[Телеком][9]|Яндекс.Практикум|Необходимо научиться прогнозировать отток клиентов.|`pandas` `numpy` `matplotlib` `seaborn` `sklearn` `бустинг` `кластеризация` `PCA` `t-SNE`|Завершен|
