...
- Ассистент по курсу:
  - \[2021, 4 курс, 1 семестр] [Глубинные методы обучения](http://wiki.cs.hse.ru/Современные_методы_машинного_обучения_(майнор_ИАД))
...
- \[2020-2021, 2-3 курсы] Майнор, Интеллектуальный анализ данных (ИАД):
  ...
  - [Глубинные методы обучения](http://wiki.cs.hse.ru/Современные_методы_машинного_обучения_(майнор_ИАД))
...
|:-------|:-------:|:-------|:-------|:-------:|
|[Предсказание цен на недвижимость][1]|ИАД|Необходимо реализовать алгоритмы kNN и линейного регрессии с нуля и добиться качества не больше 0.121 на тестовых данных по метрике *RMSE*.|pandas, sklearn, matplotlib, seaborn, numpy|`Завершен`|
