...
**Университет (ВШЭ):**
- Ассистент по курсу:
  - [Машинное обучение (продвинутый уровень)](http://wiki.cs.hse.ru/Машинное_обучение_(ФЭН)_-_2020), ФЭН, 2020 (3 курс)
- Майнор, Интеллектуальный анализ данных (ИАД):
  - [Введение в анализ данных](http://wiki.cs.hse.ru/Введение_в_анализ_данных_(майнор_ИАД)), 2020 (2 курс)
  - [Современные методы машинного обучения](http://wiki.cs.hse.ru/Современные_методы_машинного_обучения_(майнор_ИАД)), 2020 (3 курс)
  - [Прикладные задачи анализа данных](http://wiki.cs.hse.ru/Прикладные_задачи_анализа_данных), 2021 (3 курс)
- Курсовая работа:
